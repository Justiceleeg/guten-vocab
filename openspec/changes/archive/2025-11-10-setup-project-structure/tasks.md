...
- [x] Create `backend/` directory for FastAPI application
  - [x] Create `backend/app/` subdirectory
...
- [x] Create `data/` directory for static data files
  - [x] Create `data/vocab/` for grade-level vocabulary JSON files
  - [x] Create `data/mock/` for generated mock data
  - [x] Create `data/mock/student_essays/` subdirectory
