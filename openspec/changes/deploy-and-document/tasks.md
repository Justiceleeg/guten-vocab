...
- [ ] 1.2 Create new PostgreSQL database service on Railway
- [ ] 1.3 Note database connection string from Railway dashboard
- [ ] 1.4 Update backend `.env` with Railway database URL (for local seeding)

## 2. Railway Setup - Backend
- [ ] 2.1 Create Railway project for backend service
...
- [ ] 2.4 Connect Railway project to GitHub repository
- [ ] 2.5 Deploy backend and verify health endpoint works

## 3. Seed Railway Database
- [ ] 3.1 Update local `.env` with Railway DATABASE_URL
- [ ] 3.2 Run seed scripts: `python scripts/run_all.py`
- [ ] 3.3 Verify data in Railway PostgreSQL dashboard:
...
- [ ] 3.4 Alternative: Export local database and import to Railway (if direct seeding fails)

## 4. Vercel Setup - Frontend
- [ ] 4.1 Create Vercel account
- [ ] 4.2 Connect GitHub repository to Vercel
...
- [ ] 4.5 Deploy frontend and verify it loads

## 5. Integration Testing
- [ ] 5.1 Test deployed frontend → backend connection
- [ ] 5.2 Verify all pages load correctly:
  - `/` (home/class overview)
  - `/students` (student list)
  - `/students/[id]` (student detail)
  - `/class` (class overview)
- [ ] 5.3 Test API calls are working:
  - `GET /api/students`
  - `GET /api/students/[id]`
  - `GET /api/class/stats`
  - `GET /api/class/recommendations`
- [ ] 5.4 Verify data displays correctly:
...
- [ ] 5.5 Test on different devices/browsers (desktop, tablet, mobile)

## 6. Documentation - README
- [ ] 6.1 Enhance README.md with:
...
- [ ] 7.1 Create `scripts/README.md` with:
...
- [ ] 8.5 Verify .gitignore files are complete:
